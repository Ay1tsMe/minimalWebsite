...
{{ resize_image(path="images/blog/dactylplaceholder.jpg", width=850, height=450 op="fit") }}
...
{{ resize_image(path="images/blog/nice!nano.jpg", width=1200, height=800 op="fit") }}
...
{{ resize_image(path="images/blog/sanded.jpg", width=850, height=450 op="fit") }}
...
{{ resize_image(path="images/blog/primed.jpg", width=850, height=450 op="fit") }}
...
{{ resize_image(path="images/blog/painted.jpg", width=1200, height=800 op="fit") }}

{{ resize_image(path="images/blog/painted2.jpg", width=850, height=450 op="fit") }}
...
{{ resize_image(path="images/blog/dactyl_manuform_left_wire_diagram.png", width=850, height=450 op="fit") }}
{{ resize_image(path="images/blog/dactyl_manuform_right_wire_diagram.png", width=935, height=520 op="fit") }}
...
{{ resize_image(path="images/blog/wiredrows.jpg", width=850, height=450 op="fit") }}
...
{{ resize_image(path="images/blog/wiredcolumns.jpg", width=850, height=450 op="fit") }}
{{ resize_image(path="images/blog/wiredcolumns2.jpg", width=850, height=450 op="fit") }}
...
{{ resize_image(path="images/blog/dactylio.jpg", width=1200, height=800 op="fit") }}
...
{{ resize_image(path="images/blog/finalwiring2.jpg", width=1200, height=800 op="fit") }}

{{ resize_image(path="images/blog/finalwiring.jpg", width=850, height=450 op="fit") }}
...
# Final Result
{{ resize_image(path="images/blog/dactyl.jpg", width=850, height=450 op="fit") }}
...
{{ resize_image(path="images/blog/dactylmeme.jpg", width=1000, height=710 op="fit") }}
